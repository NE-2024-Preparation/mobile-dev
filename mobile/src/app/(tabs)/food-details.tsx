...
import FeaturedFood from "@/components/ui/FeaturedFood";
    ...
    <SafeAreaView className='h-full bg-[#f3f4f6]'>
      <ScrollView>
        ...
        >
          <TouchableOpacity
            onPress={() => router.back()}
            className='absolute h-[35px] w-[40px] bg-[#000000a4] top-8 left-4 rounded-full items-center justify-center z-10'
          >
